...
az vm run-command invoke -g ${RESOURCE_GROUP} -n ${CKAN_VM_NAME} --command-id RunShellScript --scripts @./postgres_datastore_provision.sh --parameters arg1="$CKAN_PG_USER_PARTIAL" arg2="$POSTGRES_PASSWORD" arg3="$PG_HOST" arg4="$PG_HOST_FULL" arg5="${DATASTORE_READONLY_PASSWORD}"
