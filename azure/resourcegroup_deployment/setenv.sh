...
ADFS_TENANT_ID=$(jq -r '.parameters.param_azure_auth_tenantid.Value' ./parameters.json)
ADFS_CLIENT_ID=$(jq -r '.parameters.param_azure_auth_clientid.Value' ./parameters.json)
ADFS_CLIENT_SECRET=$(jq -r '.parameters.param_azure_auth_client_secret.Value' ./parameters.json)
